...
<div class="pp_wrap rm_wrap">
	...
	<h3>Q: How can I link to menus categories, galleries?</h3>
	A: To use menus categories, galleries.<br/><br/>

	Once you assign menu to menu category or create gallery. Go to appearance >menus. Then select which menus category or gallery you want to add to your menu items.<br/><br/>

If you can see it, click on screen option (top right) and check on menus categories, galleries</a>
