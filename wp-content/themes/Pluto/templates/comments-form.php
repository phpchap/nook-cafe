<?php if ('open' == $post->comment_status) : ?>
	...
	<?php else : ?>
			...
			<?php else : ?>
						<br/>
						<p> 
							<input class="round m input" name="author" title="<?php _e( 'Name', THEMEDOMAIN ); ?>*" type="text" id="author" value="" tabindex="1" style="width:95%" /> 
						</p> 
						<br/>
						<p> 
							<input class="round m input" name="email" title="<?php _e( 'Email', THEMEDOMAIN ); ?>*" type="text" id="email" value="" tabindex="2" style="width:95%" /> 
						</p> 
						<br/>
						<p> 
							<input class="round m input" name="url" title="<?php _e( 'Website', THEMEDOMAIN ); ?>" type="text" id="url" value="" tabindex="3" style="width:95%" /> 
						</p> 
						<br/>
			...
			<?php endif; ?>
						...
						<p> 
							<textarea name="comment" cols="40" rows="3" title="<?php _e( 'Message', THEMEDOMAIN ); ?>*" id="comment" tabindex="4" style="width:95%"></textarea> 
						</p> 
						<br /> 
						<p> 
