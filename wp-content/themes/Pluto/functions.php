...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'blog', 490, 240, true );
}
...
include (get_template_directory() . "/plugins/troubleshooting.php");
...
include (get_template_directory() . "/plugins/aq_resizer.php");
